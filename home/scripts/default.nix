...
let
  ...
  '';
  cool-retro-term-fish = pkgs.writeShellScriptBin "cool-retro-term-fish" ''
    cool-retro-term -e fish
  '';
...
rofi \
  ...
  default_wall = pkgs.writeShellScriptBin "default_wall" ''
    if command -v swww >/dev/null 2>&1; then 
          swww img ~/Images/wallpapers/menhera.jpg  --transition-type simple
    fi
  '';
in
{
  home.packages = with pkgs; [
    cool-retro-term-fish
    rofi1
    rofi2
    rofiWindow
    cava-internal
